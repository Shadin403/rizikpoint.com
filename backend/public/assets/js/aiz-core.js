...
(function ($) {
    ...
    AIZ.plugins = {
        ...
        tooltip: function () {
            ...
            $('body').tooltip({selector: '[data-toggle="tooltip"]'}).on('click', '[data-toggle="tooltip"]', function () {
                $(this).tooltip("hide");
            });
        },
        countDown: function () {
        ...
        noUiSlider: function(){
            if ($(".aiz-range-slider")[0]) {
                $(".aiz-range-slider").each(function () {
                    ...
                    noUiSlider.create(c, {
                        start: [
                            parseInt(d.getAttribute("data-range-value-low")) || 0,
                            parseInt(e.getAttribute("data-range-value-high")) || 100000,
                        ],
                        connect: !0,
                        range: {
                            min: parseInt(c.getAttribute("data-range-value-min")) || 0,
                            max: parseInt(c.getAttribute("data-range-value-max")) || 100000,
                        },
                    }),
