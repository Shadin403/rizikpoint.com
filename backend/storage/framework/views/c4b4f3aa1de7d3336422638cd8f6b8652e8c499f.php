            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('business_settings.update')); ?>" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label"><?php echo e(translate('Frontend URL')); ?></label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="frontend_url">
                                <input type="text" name="frontend_url" class="form-control" value="<?php echo e(get_setting('frontend_url')); ?>" placeholder="https://example.com">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label"><?php echo e(translate('Site Favicon')); ?></label>
                            <div class="col-sm-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary"><?php echo e(translate('Browse')); ?></div>
                                ...
                                <div class="file-preview box sm"></div>
                                <small><?php echo e(translate('Recommended size: 32x32 or 64x64 px (.ico, .png, .svg)')); ?></small>
                            </div>
                        </div>
                        <div class="form-group row">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kachermart\backend\resources\views/backend/setup_configurations/general_settings.blade.php ENDPATH**/ ?>