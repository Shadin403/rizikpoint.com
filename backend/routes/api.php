...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::get('delivery-infos', 'Api\V2\DeliveryInfoController@index');
    ...
    Route::post('carts/sync', 'Api\V2\CartController@sync')->middleware('auth:sanctum');
    ...
    Route::post('reviews/{id}', 'Api\V2\ReviewController@update')->name('api.reviews.update');
    Route::delete('reviews/{id}', 'Api\V2\ReviewController@destroy')->name('api.reviews.destroy');
    ...
    Route::get('sliders/all', 'Api\V2\SliderController@all');
    Route::post('sliders', 'Api\V2\SliderController@store');
    Route::post('sliders/{id}', 'Api\V2\SliderController@update');
