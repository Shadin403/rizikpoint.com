    ...
    public function getList(Request $request)
    {
        ...
        if ($list == "online" || $list == "both") {
            if (get_setting('uddoktapay_payment') == 1) {
                $payment_type = array();
                $payment_type['payment_type'] = 'uddoktapay_payment';
                $payment_type['payment_type_key'] = 'uddoktapay';
                $payment_type['image'] = static_asset('assets/img/cards/uddoktapay_logo.png');
                $payment_type['name'] = "UddoktaPay";
                $payment_type['title'] = "Checkout with UddoktaPay";
                $payment_type['offline_payment_id'] = 0;
                $payment_type['details'] = "";
                if ($mode == 'wallet') {
                    $payment_type['title'] = "Recharge with UddoktaPay";
                }
