            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-lg-8">
                                <select name="choice_attributes[]" id="choice_attributes" data-selected-text-format="count" data-live-search="true" class="form-control aiz-selectpicker" multiple data-placeholder="<?php echo e(translate('Choose Attributes')); ?>">
                                    ...
                                    <option value="<?php echo e($attribute->id); ?>" <?php if(in_array($attribute->id, $productAttributes)): ?> selected <?php endif; ?>><?php echo e($attribute->getTranslation('name')); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="customer_choice_options" id="customer_choice_options">
                            <?php $__currentLoopData = $productChoiceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $choice_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-group row">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control aiz-selectpicker attribute_choice" data-live-search="true" name="choice_options_<?php echo e($choice_option->attribute_id); ?>[]" multiple>
                                        ...
                                        <option value="<?php echo e($row->value); ?>" <?php if(in_array($row->value, (array) ($choice_option->values ?? []), true)): ?> selected <?php endif; ?>>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label"><?php echo e(translate('Return Policy')); ?></label>
                            <div class="col-lg-9">
                                <textarea class="form-control" name="return_policy" rows="6" placeholder="<?php echo e(translate('Enter the return policy for this product')); ?>"><?php echo e($product->return_policy); ?></textarea>
                                <small class="text-muted"><?php echo e(translate('Shown on the storefront in the product\'s Return Policy tab. If empty, the global default from Delivery Info is used.')); ?></small>
                            </div>
                        </div>
                        <!-- <div class="form-group row">-->
                              
                        <!--    <label class="col-lg-3 col-from-label"><?php echo e(translate('Short Description')); ?></label>-->
                        <!--    <div class="col-lg-8">-->
                        <!--        <textarea name="shortdescription" rows="8" class="form-control"><?php echo e($product->shortdescription); ?></textarea>-->
                        <!--    </div>-->
                        <!--</div>-->
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\rizikpoint\backend\resources\views/backend/product/products/edit.blade.php ENDPATH**/ ?>