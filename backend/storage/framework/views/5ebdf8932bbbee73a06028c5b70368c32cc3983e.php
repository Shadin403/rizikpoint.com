    ...
    <div class="card-body">
        ...
        <div class="row gutters-5">
            <div class="col text-center text-md-left">
                <address>
                    ...
                    <?php echo e(json_decode($order->shipping_address)->address); ?>,  <?php echo e(json_decode($order->shipping_address)->country); ?><br>
        ...
        <div class="clearfix float-right">
            ...
            <div class="text-right no-print">
                <a href="<?php echo e(route('invoice.download', $order->id)); ?>" type="button" class="btn btn-icon btn-light" target="_blank"><i class="las la-print"></i></a>
            </div>
        </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\ecom3\backend\resources\views/backend/sales/all_orders/show.blade.php ENDPATH**/ ?>