            ...
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle btn-light" href="<?php echo e(get_setting('frontend_url') ?? route('home')); ?>" target="_blank" title="<?php echo e(translate('Browse Website')); ?>">
...
<?php /**PATH D:\laragon\www\kachermart\backend\resources\views/backend/inc/admin_nav.blade.php ENDPATH**/ ?>