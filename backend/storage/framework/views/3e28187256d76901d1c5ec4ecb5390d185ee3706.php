        ...
        <div class="card-header row gutters-5">
            ...
            <div class="dropdown mb-2 mb-md-0">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#" onclick="bulk_invoice_download()"> <?php echo e(translate('Download Invoices')); ?></a>
...
//        }
        ...
        function bulk_invoice_download() {
            if ($('.check-one:checked').length === 0) {
                AIZ.plugins.notify('danger', '<?php echo e(translate('Please select at least one order')); ?>');
                return;
            }
            
            var tempForm = $('<form>', {
                action: "<?php echo e(route('invoice.bulk_download')); ?>",
                method: 'POST',
                target: '_blank'
            });
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\ecom3\backend\resources\views/backend/sales/all_orders/index.blade.php ENDPATH**/ ?>