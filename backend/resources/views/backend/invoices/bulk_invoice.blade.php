...
<body>
	...
	<div class="page-break" style="padding: 0; margin: 0;">

		@php
			$logo = get_setting('header_logo');
			$logo_path = null;
			if ($logo != null && ($asset = \App\Models\Upload::find($logo)) != null) {
				$logo_path = public_path($asset->file_name);
		...
		<div style="background: #eceff4;padding: 1rem;">
			<table>
				<tr>
					<td>
						@if(file_exists($logo_path))
							<img src="{{ $logo_path }}" height="30" style="display:inline-block;">
						@else
