...
class AizUploadController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $perPage = in_array((int) $request->per_page, [30, 50, 100, 200, 500, 1000]) ? (int) $request->per_page : 30;
        ...
        return (auth()->user()->user_type == 'seller')
            ...
            : view('backend.uploaded_files.index', compact('all_uploads', 'search', 'sort_by', 'perPage'));
    }
