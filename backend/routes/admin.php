...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/storefront-info', 'BusinessSettingsController@storefront_info')->name('storefront_info.index');
    Route::get('/delivery-info', 'Api\V2\DeliveryInfoController@adminIndex')->name('delivery_info.index');
    Route::post('/delivery-info/save', 'Api\V2\DeliveryInfoController@save')->name('delivery_info.save');
    ...
    Route::group(['prefix' => 'website'], function() {
        ...
        // Sliders CRUD
        Route::get('/sliders', 'SliderController@index')->name('sliders.admin.index');
