            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Return Policy')}}</label>
                            <div class="col-lg-9">
                                <textarea class="form-control" name="return_policy" rows="6" placeholder="{{ translate('Enter the return policy for this product') }}">{{ $product->return_policy }}</textarea>
                                <small class="text-muted">{{ translate('Shown on the storefront in the product\'s Return Policy tab. If empty, the global default from Delivery Info is used.') }}</small>
                            </div>
                        </div>
                        <!-- <div class="form-group row">-->
