...
class CartController extends Controller
{
            ...
            if($carts && count($carts) > 0){
                ...
                foreach ($carts as $key => $cartItem){
                    ...
                    if($cartItem['product_id'] == $request->id) {
                        $product_stock = $cart_product->stocks->where('variant', $str)->first() ?: $cart_product->stocks->first();
                        $quantity = $product_stock ? $product_stock->qty : 0;
                        ...
                        if(($str != null && $cartItem['variation'] == $str) || $str == null){
                            ...
                            if($cart_product->wholesale_product && $product_stock){
                                $wholesalePrice = $product_stock->wholesalePrices->where('min_qty', '<=', $request->quantity)->where('max_qty', '>=', $request->quantity)->first();
                                if($wholesalePrice){
                                    $price = $wholesalePrice->price;
                                }
    ...
    public function updateQuantity(Request $request)
    {
        ...
        if($cartItem['id'] == $request->id){
            ...
            $product_stock = $product->stocks->where('variant', $cartItem['variation'])->first() ?: $product->stocks->first();
            $quantity = $product_stock ? $product_stock->qty : 0;
            $price = $product_stock ? $product_stock->price : $product->unit_price;
